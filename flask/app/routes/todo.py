...
@views_bp.route("/comedycentral")
def comedy():
    return render_template("comedycentral.html")

@views_bp.route("/game-jam-entries")
def game_jam_entries():
    return render_template("game-jam-entries.html")

@views_bp.route("/game-jam-entries/okt23-maks-uflaks/peak-of-gim/<path:filename>")
...
@views_bp.route("/game-jam-entries/okt23-maks-uflaks/crime-download/<path:filename>")
